...
public class PayrollRunItem {
    ...
    @Column(name = "remove_meal_allowance", nullable = false)
    private Boolean removeMealAllowance;

    @Column(name = "transport_allowance_num")
    private Integer transportAllowanceNum;

    @Column(name = "transport_allowance_amount")
    private BigDecimal transportAllowanceAmount;

    @Column(name = "total_transport_allowance")
    private BigDecimal totalTransportAllowance;

    @Column(name = "remove_transport_allowance", nullable = false)
    private Boolean removeTransportAllowance;
    ...
    private OffsetDateTime lockedBy;
}

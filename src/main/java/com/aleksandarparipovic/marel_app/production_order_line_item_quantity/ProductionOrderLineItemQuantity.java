package com.aleksandarparipovic.marel_app.production_order_line_item_quantity;
...
@Entity
@Table(name = "production_order_line_item_quantities")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ProductionOrderLineItemQuantity {

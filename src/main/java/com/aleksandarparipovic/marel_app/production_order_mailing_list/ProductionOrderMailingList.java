...
/**
 * Records that a mailing list was SELECTED for a production order.
 *
 * <p>Intent only — the recipients it produced live in production_order_recipients
 ...
 * by uq_production_order_mailing_lists.
 */
@Entity
@Table(name = "production_order_mailing_lists")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ProductionOrderMailingList {

...
/**
 * One past sample order, offered as somewhere to copy line items FROM.
 *
 ...
 */
public record SampleOrderCopySourceRow(
        Long id,
        String code,
        String name,
        String note,
        ...
        /** Who wrote the order — the "ko je radio nalog" the filter narrows by. */
        Long userId,
        String userFullName,
        boolean matched,
        List<SampleOrderCopySourceLineItemRow> lineItems
) {
}
